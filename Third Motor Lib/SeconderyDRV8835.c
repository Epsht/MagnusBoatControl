...
const unsigned char _M1DIR = 11;
const unsigned char _M1PWM = 12;
const unsigned int _StepTime = 10000; // in miliseconds
const unsigned int _StepSpeed = 400; // bitween 0 to 400
